...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php /*esc_html_e( 'Skip to content', 'corallina' ); */?></a>
...
/*			else :
				*/?>
				...
				<?php
/*			endif;
			$corallina_description = get_bloginfo( 'description', 'display' );
			if ( $corallina_description || is_customize_preview() ) :
				*/?>
				<p class="site-description"><?php /*echo $corallina_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */?></p>
			<?php /*endif; */?>
		</div>

		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php /*esc_html_e( 'Primary Menu', 'corallina' ); */?></button>
			<?php
/*			wp_nav_menu(
				array(
